...
export class AuthService {
  oauthTokenUrl = environment.apiUrl + '/kaspper/oauth2/token';
  oauthAuthorizeUrl = environment.apiUrl + '/kaspper/oauth2/authorize'
  jwtPayload: any ;
  ...
  logout() {
    ...
    localStorage.clear();
    window.location.href = environment.apiUrl + '/kaspper/logout?returnTo=' + environment.logoutRedirectToUrl;
  }
